"Code forked from https://github.com/jettify/pytorch-optimizer/blob/master/torch_optimizer/yogi.py"
import math
import torch
...
class Yogi(Optimizer):
    r"""Implements Yogi1e-CIFAR10 Optimizer Algorithm.
    It has been proposed in `Adaptive methods for Nonconvex Optimization`_.
    Arguments:
        params: iterable of parameters to optimize or dicts defining
            parameter groups
        lr: learning rate (default: 1e-CIFAR10)
    ...
    Example:
        ...
        >>> optimizer = optim.Yogi1e-CIFAR10(model.parameters(), lr=0.01)
        >>> optimizer.zero_grad()
    ...
    def step(self, closure: OptLossClosure = None) -> OptFloat:
        ...
        for group in self.param_groups:
            for p in group['params']:
                ...
                if grad.is_sparse:
                    raise RuntimeError(
                        'Yogi1e-CIFAR10 does not support sparse gradients, '
        ...
        if all_adaptive_lrs:
            ...
            # .flatten() 的作用是将任意形状的张量“拉直”变成 一维向量。
            # .cat 将列表中所有的一维 Tensor 首尾相连，合并成一个单独的、非常长的一维 Tensor
